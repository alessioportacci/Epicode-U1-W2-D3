...
console.log("female cast", femaleCharacters)
...
for(let i = 0; i < starWarsCharacters.length; i++)
  ...
  console.log("Cast eyeColor", eyeColor)
...
switch (true)
{
  case crewMass > 1000:starWarsCharacters
...
console.log("Now robots have a gender!",starWarsCharacters)
...
/* --EXTRA-- ESERCIZIO 9
  ...
  for(let i = 0; i < femaleCharacters.length; i++)
    for(let j = 0; j < starWarsCharacters.length; j++)
      if(starWarsCharacters[j].name === femaleCharacters[i].name)
        starWarsCharacters.splice(j, 1)

  console.log("Male/Robot cast", starWarsCharacters)
...
let randomNumber = parseInt(Math.random() * (8 - 1) + 1)
let text = ""
for (let i in starWarsCharacters[randomNumber])
  {
    text += starWarsCharacters[randomNumber][i] + " "
  }
